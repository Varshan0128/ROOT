  ...
  class PointerHandler {
    ...
    constructor(element: HTMLCanvasElement, scale: number) {
      ...
      element.addEventListener("pointerdown", (e: PointerEvent) => {
        this.active = true;
        this.pointers.set((e as any).pointerId, map(element, this.getScale(), (e as any).clientX, (e as any).clientY));
      });
      ...
      element.addEventListener("pointerup", (e: PointerEvent) => {
        ...
        this.pointers.delete((e as any).pointerId);
      ...
      element.addEventListener("pointermove", (e: PointerEvent) => {
        ...
        this.lastCoords = [(e as any).clientX, (e as any).clientY];
        this.pointers.set((e as any).pointerId, map(element, this.getScale(), (e as any).clientX, (e as any).clientY));
        this.moves = [this.moves[0] + (e as any).movementX, this.moves[1] + (e as any).movementY];
      });
    }
...
const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <div className={`relative w-full h-screen overflow-hidden bg-black ${className}`}>
      {/* IMPORTANT: include integration CSS file in testing steps to see animations */}
      <canvas
        ref={canvasRef}
